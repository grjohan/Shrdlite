...
public class Planner {
    ...
    private void CarryOutCommand(Command command)
    {    // find out where exactly my block is if I want to move or take something
  ...
  // ------------------------- below here is parsing ---------------------------------
    ...
    {   // create the entities given in world.js
